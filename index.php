...
<body class="p-3">
    ...
    <form class="p-3" action="" method="GET">
        ...
        <div class="d-flex justify-content-between mb-3">
            ...
            <input type="number" id="passwordLength" name="passwordLength" min="1" max="10" value="<?php echo isset($_GET['passwordLength']) ? $_GET['passwordLength'] : ''; ?>" placeholder="max 10" class="w-50">
        </div>
